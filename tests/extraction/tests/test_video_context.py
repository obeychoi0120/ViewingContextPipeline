...
from viewing_context_pipeline.extraction.scene_context_extraction.graph_core.video_context import (
...
def test_write_video_context_uses_exact_wrapper_and_skips_null_graphs(tmp_path) -> None:
    ...
    output = tmp_path / "video_context_graph_gemini" / "demo_context_graph_gemini.json"
