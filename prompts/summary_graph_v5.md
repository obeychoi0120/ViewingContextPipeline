Summarize the supplied scene observations into brief, natural English prose describing the video. Aim for 200-300 words in total and never exceed 350 words. Fewer than 200 words are welcome when the evidence is sparse. Do not pad to reach a target length.
