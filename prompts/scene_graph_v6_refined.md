...
Write none alone for an empty Entities or Actions section, and topics: none for no topic. No JSON, bullets, code fences, or additional sections. Stop after the actions. Be concise; limits are ceilings, not quotas.
