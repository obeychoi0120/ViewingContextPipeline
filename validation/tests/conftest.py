...
def config_data(root: Path, *, users: int = 2) -> dict:
    return {
        "schema_version": "viewing-context-experiment/v2", "run_id": "test",
        "dataset": {"pairs_tsv": root / "pairs.tsv", "videos_dir": root / "videos", "vp_graph_dir": root / "graph", "vp_desc_dir": root / "desc"},
        "cohort": {"user_count": users, "smoke_user_count": 1, "seed": 42, "min_sequence_length": 5, "max_sequence_length": 13, "history_strata": [5, 10, 20, 50]},
